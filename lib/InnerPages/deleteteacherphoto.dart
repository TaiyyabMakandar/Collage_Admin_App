...
class DeleteTeacherPhotot extends StatefulWidget {
  const DeleteTeacherPhotot({ Key? key }) : super(key: key);

  @override
  _DeleteTeacherPhototState createState() => _DeleteTeacherPhototState();
}

class _DeleteTeacherPhototState extends State<DeleteTeacherPhotot> {
  ...
  Widget build(BuildContext context) {
   return Scaffold(
        ...
        appBar: AppBar(title: Text('Delete Teacher Photo'),),
        body: Padding(
                            ...
                            onPressed: () async {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  ...
                                  content: Text("Teacher Photo Deleted Successfully"),
                                ),
                              );
                            },
                          ),
