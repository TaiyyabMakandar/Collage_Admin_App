...
class ViewTeacherData extends StatefulWidget {
  const ViewTeacherData({Key? key}) : super(key: key);

  @override
  _ViewTeacherDataState createState() => _ViewTeacherDataState();
}

class _ViewTeacherDataState extends State<ViewTeacherData> {
  late Query _ref;
